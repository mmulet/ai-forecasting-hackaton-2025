...
def evaluate_model_on_adele() -> Task:
    ...
    return Task(
        ...
        # solver=mas_agent("unsloth/Qwen2.5-7B-Instruct" , current_dir / "mas_configs" / "autocrat_3.yaml"),
        solver=mas_agent("unsloth/Qwen2.5-7B-Instruct" , current_dir / "mas_configs" / "single.yaml"),
        scorer=[score_sample()],
